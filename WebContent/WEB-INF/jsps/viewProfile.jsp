	...
	<div class="container">
		...
		<div class="profile">
			...
			<div class="profile-image">
				...
				<img src="data:image/jpg;base64,${user.getPicture_str()}" alt="profile" width="200" height="200">
			...
			<div class="profile-stats">
				...
				<ul>
					<li><span class="profile-stat-count"><c:out value="${user.getPosts().size() }"/>  </span> posts</li>
					<li><span class="profile-stat-count"><c:out value="${user.getContacts().size() }"/> </span> followers</li>
			...
			<div class="profile-bio">
				...
				<p><span class="profile-real-name">${user.getEmail()}</span>  📷✈️🏕️</p>
				<sf:form method="post" action="addPost?user_id=${user.getId()}" modelAttribute="newPost" >
							
						<div class="input-file-container">  
					    <sf:input id="file" type="file"  class="fa fa-plus-circle" name="sendPicture" path="post" />
