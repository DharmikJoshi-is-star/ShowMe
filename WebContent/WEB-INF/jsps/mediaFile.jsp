...
<div class="container">
  ...
  <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModalForPDF">
  myModalToDisplayForm</button>

  <!-- Modal -->
  <div class="modal fade" id="myModalForPDF" role="dialog">
