...
<div class="navigation open">
	...
	<div class="container">
		...
		<div class="profile">
			...
			<div class="profile-user-settings">
				...
				<h1 class="profile-user-name">${receiver.getName()}</h1>

				<a href="removeFriend?user_id=<c:out value="${user_id }"/>&contact_id=<c:out value="${receiver.getId() }"/>"> 
					<button class="btn profile-edit-btn">remove friend</button>
				</a>	
			</div>
			...
			<div class="profile-bio">
				...
				<p>Username: <span class="profile-real-name">${receiver.getEmail()}</span> </p>
			</div>
	...
	<div class="container">
		...
		<div class="gallery">
			...
			<c:forEach items="${receiver.getPosts() }" var="posts">
