...
<div class="modal fade bd-example-modal-xl" id="1" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      lsknvlknvkdnvklndknkdklnklsncknsknck
      kdvndnv
      dnv
      dvn
      dknv
...
<section class="hero">
			<div class="container">
				<div class="row">	
					<div class="col-lg-6 " id="img-11">
						<div class="cardbox shadow-lg bg-white" data-toggle="modal" data-target="#1">
