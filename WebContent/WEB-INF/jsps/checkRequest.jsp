...
<link href="WebContent/WEB-INF${pageContext.request.contextPath}/css/checkRequest.css"
    rel="stylesheet"> 
<link href="<c:url value="resources/checkRequest.css" />" rel="stylesheet">
...
<script src="https://kit.fontawesome.com/81c2c05f29.js" crossorigin="anonymous"
		></script>
<!-- END FOR TOOL TIP -->
...
<c:set var="requestS" value="0"></c:set>
...
<div class="container my-margin">
	<c:forEach items="${requestedUsers }" var="user">
		...
		<c:if test="${user eq null }">
			...
			<c:set var="requestS" value="1"></c:set>			
				...
				<div class="row">
					...
					<div class="col">
						...
						<div class="card-link row">
							<a href="addFriend?userId=${userId}&contactId=${user.id}" class="card-link col col-md-4">Accept Request</a>
							<a href="rejectRequest?userId=${userId}&contactId=${user.id}" class="card-link col col-md-4">Reject Request</a>
						</div>
					</div>
